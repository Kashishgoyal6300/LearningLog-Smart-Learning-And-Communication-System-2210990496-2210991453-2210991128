...
export default function SignupPage() {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || "Email already exists or signup failed");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={styles.header}>
          <h2 style={{...styles.title, color: theme.text}}>Create Account</h2>
          <p style={{...styles.subtitle, color: theme.textSecondary}}>Join our learning community</p>
        </div>
        ...
        <div style={styles.form}>
          <div style={styles.formGroup}>
            <label style={{...styles.label, color: theme.text}}>Full Name</label>
            <input
              style={{
                ...styles.input,
        ...
        <div style={styles.footer}>
          <p style={{color: theme.textSecondary}}>Already have an account? <Link to="/" style={{...styles.link, color: theme.primary}}>Login here</Link></p>
        </div>
      </div>
    </div>
  );
